...
class XmlTest < Minitest::Test
  ...
  describe RubySaml::XML::SignedDocumentValidator do
    ...
    it "should run validate with throwing NS related exceptions" do
      assert_raises(RubySaml::ValidationError) do
        RubySaml::XML::SignedDocumentValidator.validate_signature(decoded_response, @base64cert, soft: false)
      end
    end
    ...
    it "should raise Fingerprint mismatch" do
      ...
      exception = assert_raises(RubySaml::ValidationError) do
        RubySaml::XML::SignedDocumentValidator.validate_document(decoded_response, "no:fi:ng:er:pr:in:t", errors, soft: false)
      end
    ...
    it "should raise Digest mismatch" do
      errors = []
      exception = assert_raises(RubySaml::ValidationError) do
        RubySaml::XML::SignedDocumentValidator.validate_signature(decoded_response, @base64cert, errors, soft: false)
      end
    ...
    it "correctly obtain the digest method with alternate namespace declaration" do
      ...
      base64cert = adfs_document.scan(%r{<X509Certificate>(.*)</X509Certificate>}).first.first
      assert RubySaml::XML::SignedDocumentValidator.validate_signature(adfs_document, base64cert, soft: false)
    end
  ...
  describe "#canon_algorithm" do
    it "C14N_EXCLUSIVE_1_0" do
      ...
      assert_equal canon_algorithm, RubySaml::XML.canon_algorithm("http://www.w3.org/2001/10/xml-exc-c14n#")
      assert_equal canon_algorithm, RubySaml::XML.canon_algorithm("http://www.w3.org/2001/10/xml-exc-c14n#WithComments")
      assert_equal canon_algorithm, RubySaml::XML.canon_algorithm("other")
    end

    it "C14N_1_0" do
      canon_algorithm = Nokogiri::XML::XML_C14N_1_0
      assert_equal canon_algorithm, RubySaml::XML.canon_algorithm("http://www.w3.org/TR/2001/REC-xml-c14n-20010315")
      assert_equal canon_algorithm, RubySaml::XML.canon_algorithm("http://www.w3.org/TR/2001/REC-xml-c14n-20010315#WithComments")
    end

    it "XML_C14N_1_1" do
      canon_algorithm = Nokogiri::XML::XML_C14N_1_1
      assert_equal canon_algorithm, RubySaml::XML.canon_algorithm("http://www.w3.org/2006/12/xml-c14n11")
      assert_equal canon_algorithm, RubySaml::XML.canon_algorithm("http://www.w3.org/2006/12/xml-c14n11#WithComments")
    end
  end
  ...
  describe "#algorithm" do
    it "SHA1" do
      ...
      assert_equal alg, RubySaml::XML.hash_algorithm("http://www.w3.org/2000/09/xmldsig#rsa-sha1")
      assert_equal alg, RubySaml::XML.hash_algorithm("http://www.w3.org/2000/09/xmldsig#sha1")
    end

    it "SHA256" do
      alg = OpenSSL::Digest::SHA256
      assert_equal alg, RubySaml::XML.hash_algorithm("http://www.w3.org/2001/04/xmldsig-more#rsa-sha256")
      assert_equal alg, RubySaml::XML.hash_algorithm("http://www.w3.org/2001/04/xmldsig-more#sha256")
      assert_equal alg, RubySaml::XML.hash_algorithm("other")
    end

    it "SHA384" do
      alg = OpenSSL::Digest::SHA384
      assert_equal alg, RubySaml::XML.hash_algorithm("http://www.w3.org/2001/04/xmldsig-more#rsa-sha384")
      assert_equal alg, RubySaml::XML.hash_algorithm("http://www.w3.org/2001/04/xmldsig-more#sha384")
    end

    it "SHA512" do
      alg = OpenSSL::Digest::SHA512
      assert_equal alg, RubySaml::XML.hash_algorithm("http://www.w3.org/2001/04/xmldsig-more#rsa-sha512")
      assert_equal alg, RubySaml::XML.hash_algorithm("http://www.w3.org/2001/04/xmldsig-more#sha512")
    end
  end
  ...
  describe 'RubySaml::XML::SignedDocument' do
    ...
    describe '#validate_document_with_cert' do
      ...
      describe 'when response cert is different from idp cert' do
        ...
        it 'is not valid' do
          exception = assert_raises(RubySaml::ValidationError) do
            RubySaml::XML::SignedDocumentValidator.validate_document_with_cert(document, idp_cert, soft: false)
          end
