...
module RubySaml
  ...
  class Settings
    ...
    def get_idp_cert
      ...
      formatted_cert = RubySaml::Utils.format_cert(idp_cert)
    ...
    def get_sp_cert
      ...
      formatted_cert = RubySaml::Utils.format_cert(certificate)
      cert = OpenSSL::X509::Certificate.new(formatted_cert)

      if security[:check_sp_cert_expiration]
        if RubySaml::Utils.is_cert_expired(cert)
          raise RubySaml::ValidationError.new("The SP certificate expired.")
        end
      end
    ...
    def get_sp_cert_new
      ...
      formatted_cert = RubySaml::Utils.format_cert(certificate_new)
      OpenSSL::X509::Certificate.new(formatted_cert)
    end
    ...
    def get_sp_key
      ...
      formatted_private_key = RubySaml::Utils.format_private_key(private_key)
