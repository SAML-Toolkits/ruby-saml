...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".document",
     ...
     "example/lib/onelogin/saml.rb",
     "example/lib/onelogin/saml/authrequest.rb",
     "example/lib/onelogin/saml/response.rb",
     "example/lib/onelogin/saml/settings.rb",
     "example/lib/xml_sec.rb",
